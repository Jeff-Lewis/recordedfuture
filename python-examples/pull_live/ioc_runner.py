...
def get_arguments():
    ...
    parser.add_argument('index_min', help="Index min (in ISO format, e.g. '2014-12-16T15:00:00.000Z' or any prefix thereof).")
    parser.add_argument('index_max', help="Index max (in ISO format, e.g. '2014-12-16T15:00:00.000Z' or any prefix thereof).")
